        ...
        <div class="row mb-2">
            ...
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    ...
                    <li class="breadcrumb-item active">Edit Foto SK</li>
                </ol>
            </div>
        </div>
    </div><!-- /.container-fluid -->
...
<section class="content">
  ...
  <div class="card card-info">
      <div class="card-header">
          <h3 class="card-title">Form Edit Foto SK</h3>
      </div>
      <!-- /.card-header -->
      ...
      <!-- <input type="hidden" value="id_perdes" name="id_perdes"> -->
          <div class="card-body">
            <div class="form-group col-md-6">
                <label for="foto_sk">Foto Perangkat Desa</label>
                <div class="custom-file">
                  <input type="hidden" name="foto_lama" value="<?= $data_perdes['foto_sk']; ?>">
...
$gambar1  = $_FILES['foto_sk']['name'];
// $gambar2  = explode(".",$_FILES['foto_sk']['name']);
$source1  = $_FILES['foto_sk']['tmp_name'];
// $source2  = $_FILES['foto_sk']['tmp_name'];
$size   = $_FILES['foto_sk']['size'];
...
// $baru1    = round(microtime(true)). '.' . end($gambar2);
