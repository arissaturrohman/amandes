          ...
          <div class="col-md-6 mb-2">
            <table>
              ...
              <tr>
                <td>Penghasilan</td>
                <td>
                  <?php echo ": Rp. " . number_format($data['siltap']); ?>
                </td>
              </tr>
              <tr>
                <td>Tunjangan Lainnya</td>
                <td>
                  <?php echo ": Rp. " . number_format($data['tunj']); ?>
                </td>
              </tr>
              <tr>
                <td>Bengkok</td>
                <td>
                  <?php echo ": " . $data['bengkok'] . " bahu"; ?> <a href="#" title="Rincian" data-toggle="modal" data-target="#rincian"><sup><i class="fas fa-info-circle"></i></sup></a>
                </td>
              </tr>
              <tr>
                <td>Status</td>
