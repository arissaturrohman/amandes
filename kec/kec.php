                ...
                ?>
                    <tr>
                        ...
                        <td>
                            ...
                            <a href="?page=kec&action=delete&id=<?= $data['id_kec']; ?>" name="delete" onclick="return confirm('Apakah anda yakin menghapus data ini...?')" class="badge badge-danger">delete</a>
                        </td>
                        <?php } ?>
                    </tr>
                <?php } ?>
